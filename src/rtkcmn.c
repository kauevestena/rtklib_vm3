...
#endif
#include "rtklib.h"
#include "vmf3_functions.h" // <-- ADICIONE ESTA LINHA
...
// Declaração e inicialização da variável global de cache VMF3
//vmf3_cache_t vmf3_cache = {0}; // <-- ADICIONE ESTA LINHA. Inicializa todos os membros com zero/nulo
...
/* function prototypes -------------------------------------------------------*/
#ifdef MKL // Esta diretiva deve estar AQUI e envolver APENAS as funções da MKL
#define LAPACK
#define dgemm_      dgemm
